// This file contains the code for the hubspot view component.
...
interface HubSpotViewProps {
  ...
  queryParams: IFetchHubSpotContactsQueryParamsType;
  handleHubSpotSearchSearch: (event: React.ChangeEvent<HTMLInputElement>) => void;
  crmPlatform: string
}
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <Button
              ...
              disabled={leadsLoading || !isHubspotIntegrated || loading}
                ...
                <>
                    ...
                    <div className="relative mt-4">
                        ...
                        <Input
                          ...
                          value={queryParams.leadSearch}
                          onChange={handleHubSpotSearchSearch}
                          disabled={loading}
                        />
                    </div>
                    </div>
                  ...
                  <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div className="relative mt-4">
                      ...
                      <input
                        ...
                        className="block w-full sm:w-80 pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md leading-5 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                        value={queryParams.contactSearch}
                        onChange={handleHubSpotSearchSearch}
                        disabled={loading}
                      />
                    </div>
                  ...
                  <div className="overflow-x-auto">
                    {hubSpotContacts && hubSpotContacts.length === 0 ? (
                      ...
                      <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                          {hubSpotContacts && hubSpotContacts.map((contact) => (
                            <tr key={contact.id}>
                              <td className="px-4 py-3 font-medium text-gray-900 dark:text-white">{contact.properties.firstname} {contact.properties.lastname}</td>
                              <td className="px-4 py-3 text-gray-700 dark:text-gray-300">{contact.properties.email}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
